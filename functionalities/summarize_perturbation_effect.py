def summarize_perturbation_effect(perturbations):
    ...
    for item in perturbations:
        max_degree = max(max_degree, item["statistical"][7]["value"])
        max_median_pos = max(max_median_pos, item["statistical"][2]["value"])
        max_median_negative = min(max_median_negative,
                                  item["statistical"][5]["value"])
        max_max_positive = max(max_max_positive,
                               item["statistical"][3]["value"])
        max_max_negative = min(max_max_negative,
                               item["statistical"][4]["value"])
    ...
    res = [
        ...
        {"id": "max_max_negative_influence", "value": -max_median},
        {"id": "max_median_negative_influence", "value": -max_max},
